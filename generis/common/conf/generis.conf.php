...
# local namespace
define('LOCAL_NAMESPACE','http://localhost/tao.rdf');

# platform identification
define('GENERIS_INSTANCE_NAME','tao');
define('GENERIS_SESSION_NAME','tao_bdh0HI4n');

# paths
define('ROOT_PATH','C:\\UwAmp\\www\\');
...
define('FILES_PATH','C:\\UwAmp\\www\\generis\\data\\');
