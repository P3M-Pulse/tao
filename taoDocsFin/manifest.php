...
return array(
	...
	'classLoaderPackages' => array( 
 	...
 	'constants' => array(
		...
		# default module name
		'DEFAULT_MODULE_NAME'	=> 'TestController',
	
		#default action name
		'DEFAULT_ACTION_NAME'	=> 'sayHello',
	
		#BASE PATH: the root path in the file system (usually the document root)
		'BASE_PATH'				=> $extpath,
	
		#BASE URL (usually the domain root)
		'BASE_URL'				=> ROOT_URL . '/taoDocsFin',
	
		#BASE WWW the web resources path
		'BASE_WWW'				=> ROOT_URL . '/taoDocsFin/views/',
	 
	 	'DOCS_PATH'				=> $extpath."views".DIRECTORY_SEPARATOR."data".DIRECTORY_SEPARATOR,
	 	'DOCS_URL'				=> ROOT_URL."/taoDocsFin/views/data/",
